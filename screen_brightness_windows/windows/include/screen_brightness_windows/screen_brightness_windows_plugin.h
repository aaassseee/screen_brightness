...
namespace screen_brightness {
    ...
    private:
        ...
        void HandleGetSystemScreenBrightnessMethodCall(
        ...
        void HandleGetApplicationScreenBrightnessMethodCall(
            std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result);
        ...
        void HandleResetApplicationScreenBrightnessMethodCall(
            std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result);

        void HandleApplicationScreenBrightnessChanged(long brightness);

        void HandleHasApplicationScreenBrightnessChangedMethodCall(
            std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result) const;
        ...
        // Auto-brightness handlers (Windows: no adaptive brightness API across all systems)
        void HandleIsAutoBrightnessMethodCall(std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result);

        void HandleSetAutoBrightnessMethodCall(const flutter::MethodCall<flutter::EncodableValue> &call,
                                               std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result);
        ...
        void HandleCanChangeSystemBrightnessMethodCall(
            std::unique_ptr<flutter::MethodResult<flutter::EncodableValue> > result);

        std::optional<LRESULT> HandleWindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

        void GetScreenBrightness(long &minimum_screen_brightness, long &screen_brightness,
