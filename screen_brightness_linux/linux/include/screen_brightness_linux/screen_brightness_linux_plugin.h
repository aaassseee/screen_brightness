...
typedef struct _ScreenBrightnessLinuxPlugin ScreenBrightnessLinuxPlugin;
typedef struct {
  GObjectClass parent_class;
} ScreenBrightnessLinuxPluginClass;

FLUTTER_PLUGIN_EXPORT GType screen_brightness_linux_plugin_get_type();
